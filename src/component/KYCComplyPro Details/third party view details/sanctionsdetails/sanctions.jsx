              ...
              <table className="General-Table-Section">
                ...
                <tr className="General-Bottom-Section">
                  <td className="General-bottom-title">
                    ВЕЛЕЖАНІН А. О.,VELEZHANIN AO,Вележанін А. О.,ВЕЛЕЖАНИН А.
                    О.
                  </td>
                ...
                <tr className="General-Top-Section">
                  <td className="General-title">
                    ЛОБАНОВСЬКИЙ Дмитро А.,Лобановський Дмитро А.,LOBANOVSKY
                    Dmitry A.,ЛОБАНОВСКИЙ Дмитрий А.
                  </td>
...
export default SanctionsDetailsBox;
